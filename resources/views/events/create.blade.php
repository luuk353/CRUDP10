            ...
            <form action="{{ route('events.store') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    ...
                    <x-section.input type=text name=event_naam id=event_naam placeholder="Game event!"
                        class="bg-gray-700" value="{{ old('event_naam') }}" />
                </div>
                <div class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <x-section.input type=text name=event_locatie id=event_locatie value="{{ old('event_locatie') }}"
                ...
                <div class="mb-4">
                    ...
                    <x-section.input type=date name=begin_datum id=begin_datum value="{{ old('begin_datum') }}"
                        class="bg-gray-700" placeholder=dd/mm/yyyy max=9999-12-31 />
                </div>
                <div class="mb-4">
                    ...
                    <x-section.input type=time name=begin_tijd id=begin_tijd placeholder=12:12:12 class="bg-gray-700"
                        value="{{ old('begin_tijd') }}" />
                </div>
                <div class="mb-4">
                    <x-section.label for=eind_datum>
                        Eind datum event
                    </x-section.label>
                    <x-section.input type=date name=eind_datum id=eind_datum value="{{ old('eind_datum') }}"
                        class="bg-gray-700" placeholder=dd/mm/yyyy max=9999-12-31 />
                </div>
                <div class="mb-4">
                ...
                <div class="flex justify-center">
                    <button type="submit"
                        class="transform rounded-full bg-orange-500 px-4 py-2 font-bold text-white transition duration-300 ease-in-out hover:scale-105 hover:bg-pink-400">Verstuur</button>
                </div>
            </form>
        </x-section.card>
    </div>
