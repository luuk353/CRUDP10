            ...
            <div class="bg-gray-800 p-8 rounded-md shadow-md">
                <form action="{{ route('reviews.store') }}" method="post">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="titel_review" class="border rounded w-full py-2 px-3 bg-gray-700 text-white focus:outline-none focus:border-indigo-500 focus:ring focus:ring-indigo-200">
                    </div>

                    <div class="mb-4">
                        <label for="beschrijving_review" class="block text-gray-200 text-sm font-bold mb-2">Beschrijving review *</label>
                        <textarea name="beschrijving_review" class="border rounded w-full py-2 px-3 bg-gray-700 text-white resize-none focus:outline-none focus:border-indigo-500 focus:ring focus:ring-indigo-200"></textarea>
                    </div>

                    <div class="mb-4">
                        <label for="rating" class="block text-gray-200 text-sm font-bold mb-2">Rating *</label>
                        <input type="number" name="rating" step="0.1" min="0" max="5" class="border rounded w-full py-2 px-3 bg-gray-700 text-white focus:outline-none focus:border-indigo-500 focus:ring focus:ring-indigo-200">
                    </div>
