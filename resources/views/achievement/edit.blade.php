    ...
    <main>
        <div class="bg-gradient-to-l from-red-600 via-orange-400 to-yellow-200 p-8 min-h-screen">
            <div class="max-w-2xl mx-auto my-8 px-4 sm:px-6 lg:px-8">
                <h1 class="text-4xl font-extrabold text-white mb-8">Achievement aanpassen!</h1>
                <div class="mb-8">
                ...
                <div class="bg-gray-800 p-8 rounded-md shadow-md">
                    <form action="{{ route('achievements.update', $achievement->id) }}" method="post">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="name" class="border rounded w-full py-2 px-3 bg-gray-700 text-white focus:outline-none focus:border-indigo-500 focus:ring focus:ring-indigo-200" value="{{old('name', $achievement->name)}}" placeholder="Naam van de achievement!">
                        </div>
                        <div class="mb-4">
                            <label for="description" class="block text-gray-200 text-sm font-bold mb-2">Beschrijving achievement *</label>
                            <textarea name="description" class="border rounded w-full py-2 px-3 bg-gray-700 text-white resize-none focus:outline-none focus:border-indigo-500 focus:ring focus:ring-indigo-200" placeholder="Beschrijving van de achievement!">{{old('description', $achievement->description)}}</textarea>
                        </div>
